...
//   prompt: string;
//   onTranscriptUpdate: (entry: { speaker: 'user' | 'ai'; text: string }) => void;
// }

// export default function LiveAudioComponent({prompt, onTranscriptUpdate}: LiveAudioComponentProps) {
...
//       updateError(e.message);
//     }
//   }, [prompt, stopRecording, onTranscriptUpdate]);
...
//             // Handle AI's output transcription
...
//           systemInstruction: prompt,
//           responseModalities: [Modality.AUDIO],
//           // Enable transcription for user input
//           inputAudioTranscription: {
//             model: 'latest',
//           },
//           // Enable transcription for AI output
//           outputAudioTranscription: {
//             model: 'latest',
//           },
//           speechConfig: {
//             voiceConfig: { prebuiltVoiceConfig: { voiceName: 'Puck' } }, // Puck works with standard model
//           },
//         },
//       });
//     } catch (e: any) {
...
export default function LiveAudioComponent({prompt, onConversationEnd, isEnding}: LiveAudioComponentProps) {
  ...
  // --- FIX 2 (cont.): This useEffect is now stable ---
  useEffect(() => {
    if (prompt) {
      initSession();
    }
